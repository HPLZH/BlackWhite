...
namespace BlackWhite.MAUI
{
    public partial class App : Application , IReLoad
    {
        ...
        public static string ReleaseDate => new DateTime(2022, 6, "?").ToLongDateString();
        ...
        public void ReLoad()
        {
            ...
            switch (settings.Language)
            {
                case "%null%":
                    ...
                    break;
                case "%system%":
                    BlackWhite.MAUI.Properties.Resources.Culture = null;
                    break;
                default:
                    BlackWhite.MAUI.Properties.Resources.Culture = System.Globalization.CultureInfo.GetCultureInfo(settings.Language);
                    break;
            }
            //askLang = true;
